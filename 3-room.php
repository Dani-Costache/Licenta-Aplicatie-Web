...
<meta charset="UTF-8">
  ...
  <title>Apartamente 3 camere - Diamond Residence Resort</title>
...
<?php endif; ?>
  ...
  <div class="underline"></div>
    ...
    <div class="property-item" data-type="3-room" data-features="Tip1">
      <img src="images/3camere/app1" alt="Apartament cu 3 camere">
      <h4>Apartament Tip 1</h4>
      <div class="property-description">
          <p>Apartamentele cu 3 camere sunt gândite pentru toți cei care au nevoie de un spațiu locativ extins, indiferent că este vorba de o cameră pentru copii sau de o cameră extra cu destinație personalizată. </p>
               <ul>
                   <li><strong>Proiect:</strong> Diamond</li>
                   <li><strong>Poziționare:</strong> Etaj 1-4</li>
                   <li><strong>Orientare:</strong> Est-Vest</li>
                   <li><strong>Suprafață:</strong> 76,3 mp utili + Terasă 3.7 mp</li>
                   <li><strong>Preț:</strong> de la 121.000 Euro(TVA inclus)</li>
               ...
               <a class="availability-button" href="3-room-disponibility.php">Vezi disponibilitatea</a>
        </div>
    </div>
    <div class="property-item" data-type="3-room" data-features="Tip 2">
      <img src="images/3camere/app2" alt="Apartament cu 3 camere">
      <h4>Apartament Tip 2</h4>
      <div class="property-description">
          <p>Apartamentele cu 3 camere sunt gândite pentru toți cei care au nevoie de un spațiu locativ extins, indiferent că este vorba de o cameră pentru copii sau o cameră extra cu o destinație personalizată.</p>
              <ul>
                   <li><strong>Proiect:</strong> Diamond</li>
                   <li><strong>Poziționare:</strong> Parter,Etaj 1-8</li>
                   <li><strong>Orientare:</strong> Est-Vest</li>
                   <li><strong>Suprafață:</strong> 72,4 mp utili + Terasă 4,4 mp</li>
                   <li><strong>Preț:</strong> de la 101.000 Euro(TVA inclus)</li>
                   <li><strong>Parcare supraterană:</strong> 2.500 Euro(TVA inclus)</li>
                   <li><strong>Parcare subterană:</strong> 5.000 Euro(TVA inclus)</li>
                   <li><strong>Boxă depozitare:</strong> Inclusă în preț</li>
               </ul>
    ...
    <div class="property-item" data-type="3-room" data-features="Tip 3">
      <img src="images/3camere/app3" alt="Apartament cu 3 camere">
      ...
      <p>Apartamentele cu 3 camere sunt gândite pentru toți cei care au nevoie de un spațiu locativ extins, indiferent că este vorba de o cameră pentru copii sau o cameră extra cu o destinație personalizată.</p>
                <ul>
                   ...
                   <li><strong>Orientare:</strong> Est-Vest</li>
                   <li><strong>Suprafață:</strong> 73,5 mp utili + Terasă 4,47 mp</li>
                   <li><strong>Preț:</strong> de la 125.000 Euro(TVA inclus)</li>
                   <li><strong>Parcare supraterană:</strong> 2.500 Euro(TVA inclus)</li>
                   <li><strong>Parcare subterană:</strong> 5.000 Euro(TVA inclus)</li>
                   <li><strong>Boxă depozitare:</strong> Inclusă în preț</li>
               </ul>
