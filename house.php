...
<meta charset="UTF-8">
  ...
  <title>Case - Diamond Residence Resort</title>
</head>
<body>
  <nav class="navbar">
  ...
  <section id="propertys">
    <div class="property-selector">
      ...
      <div class="property-obs">
        <p>Case Diamond Residence Resort combină spații generoase, menite să ofere libertate de acțiune și confort, decoruri funcționale cu o soluție completă de finisaje, totul pentru un stil de viață modern și minimalist. Lumina naturală străbate prin ferestrele mari, oferind locatarilor confort și o oază de liniște.</p>
        <p>Fiecare locuință dispune de centrală proprie și finisaje premium. Diamond Residence Resort se află în apropierea orasului Ploiesti. În zonă există numeroase spații verzi, iar accesul se face rapid către zonele comerciale din proximitate.</p>
        <p>Diamond Residence Resort reprezintă soluția pentru cei care își doresc un loc pe care să-l numească acasă. Ansamblul vine în întâmpinarea clienților cu 50 de case în Ploiesti, realizate cu cele mai bune materiale, care oferă intimitatea dorită. 
          <br> Reprezintă varianta perfectă pentru familiile tinere, aflate la început de drum, care vor o compartimentare bună, un preț optim și o zonă ferită de agitația Ploiestiului.</br></p>
        <p><br>Astfel, dacă te afli în căutarea primului apartament sau a unui loc care să-ți ofere confortul și relaxarea de care ai nevoie, venim în ajutorul tău cu o selecție largă de apartamente de vânzare.</br> 
      ...
      <div class="gallery-navigation">
        ...
        <button id="next-button">&gt;</button>
          ...
          <img src="images/case/casa2" alt="Image 2" class="gallery-image">
          <img src="images/case/casa3" alt="Image 3" class="gallery-image">
          <img src="images/case/int1" alt="Image 4" class="gallery-image">
          <img src="images/case/int2" alt="Image 5" class="gallery-image">
          <img src="images/case/int3" alt="Image 6" class="gallery-image">
          <img src="images/case/int4" alt="Image 7" class="gallery-image">
