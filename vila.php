...
<title>Vilă - Diamond Residence Resort</title>
</head>
<body>
<nav class="navbar">
...
<section id="propertys">
  ...
  <div class="property-list">
    <div class="property-item property2" data-type="Vila" data-features="Tip 1">
      <img src="images/case/vila1" alt="Vila">
      <h4>Vilă</h4>
      <div class="property-description">
        <p>Vilele noastre sunt construcții rezidențiale de lux, adesea cu o arhitectură impresionantă și facilități extinse. Acestea sunt destinate în general persoanelor care caută o locuință elegantă și confortabilă, într-o locație privilegiată.</p>
        <ul>
          ...
          <li><strong>Suprafață:</strong> 273 mp utili cu Terasă</li>
          <li><strong>Preț:</strong> de la 260.000 Euro (TVA inclus)</li>
          <li><strong>Parcare supraterană:</strong> Inclusă</li>
          <li><strong>Parcare subterană:</strong> 5.000 Euro (TVA inclus)</li>
        </ul>
        <a class="availability-button" href="vila-disponibility.php">Vezi disponibilitatea</a>
      </div>
    </div>
  </div>
</section>
